...
const PROJECTS = [
  {
    ...
    description: "A full-stack application that leverages deep learning models to generate high-quality images from text prompts.",
  ...
  },
  {
    ...
    description: "A responsive admin dashboard for e-commerce platforms with real-time analytics, inventory management, and sales tracking.",
  ...
  {
    title: "EcoTrack",
    description: "A hackathon-winning mobile-first web app that helps users track and reduce their carbon footprint through gamification.",
  ...
  },
  {
    ...
    description: "A robust REST API that performs sentiment analysis on social media posts using natural language processing.",
    tags: ["FastAPI", "Python", "Scikit-Learn", "Docker"],
    category: "AI/ML",
    liveUrl: "#",
    githubUrl: "#",
  },
